...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-x-hidden pt-16" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container mx-auto px-[8%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center min-h-screen md:justify-between gap-8 sm:gap-12 lg:gap-20">
            ...
            {/* Left Column */}
            <div
              className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left order-1"
              data-aos="fade-right"
              data-aos-delay="200"
            >
            ...
            <div
              className="w-full lg:w-1/2 h-[400px] sm:h-[500px] lg:h-[600px] xl:h-[700px] relative flex items-center justify-center order-2"
