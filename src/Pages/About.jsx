...
import { FileText, Code, Globe, Sparkles, UserCheck, ArrowUpRight } from "lucide-react"
import AOS from 'aos'
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold">
              ...
              <span className="block mt-2 text-gray-200">Marycharity Mbone</span>
            </h2>
            <p className="text-base sm:text-lg lg:text-xl text-gray-400 leading-relaxed text-justify">
              A passionate Full-Stack Developer based in Kenya.
              I specialize in building scalable web applications using React.js, Flask, and PostgreSQL.
              My focus is on crafting intuitive user experiences, clean architectures, and innovative digital solutions.
            ...
            <div className="flex flex-col lg:flex-row items-center gap-4">
              ...
              <a href="#Portofolio" className="w-full lg:w-auto">
                <button className="w-full lg:w-auto sm:px-6 py-2 sm:py-3 rounded-lg border border-[#a855f7]/50 text-[#a855f7] font-medium flex items-center justify-center gap-2 hover:bg-[#a855f7]/10">
