  ...
  useEffect(() => {
    ...
    const projectData = [
      ...
      },
      {
        ...
        title: "Drink & Chill",
        description:
          "A drinks ordering platform with GPS/geolocation functionality for location-aware delivery and a smooth mobile-first checkout experience.",
        image: "/images/drink-and-chill.png",
